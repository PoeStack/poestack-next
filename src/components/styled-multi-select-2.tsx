...
export default function StyledMultiSelect2({
  ...
  return (
    <div className="flex flex-row w-full ">
              ...
              {items.map((item, itemIndex) => (
                ...
                >
                  {({ selected }) => (
                    <>
                      <div
                        className={`block grow text-skin-base truncate ml-2 ${
      ...
      <button
        className="bg-skin-second hover:bg-skin-second-dark py-1 px-1 text-white rounded-r-lg h-[36px] mt-[4px]"
        onClick={() => {
