...
export function StashViewTabSelectionCard() {
  ...
  return (
    <>
      <StyledCard>
        <div className="flex flex-col space-y-1 max-h-[490px]">
          ...
          <StashViewTabSelectVertical
            selectedTabIds={stashViewSettings.checkedTabIds}
            onSelectChange={(tab) => {
              if (stashViewSettings.checkedTabIds.includes(tab.id)) {
                ...
                setStashViewSettings({
                  ...stashViewSettings,
                  checkedTabIds: [...stashViewSettings.checkedTabIds, tab.id],
                });
              }
            }}
          />
...
export const STASH_TAB_ICON_MAP = {
  CurrencyStash:
