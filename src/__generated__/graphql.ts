...
export type PullAllStashTabsQueryQueryVariables = Exact<{
  publicStashId: Scalars['String'];
}>;


export type PullAllStashTabsQueryQuery = { __typename?: 'Query', publicStash?: any | null };
...
export const PullAllStashTabsQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PullAllStashTabsQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"publicStashId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"publicStash"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"publicStashId"}}}]}]}}]} as unknown as DocumentNode<PullAllStashTabsQueryQuery, PullAllStashTabsQueryQueryVariables>;
